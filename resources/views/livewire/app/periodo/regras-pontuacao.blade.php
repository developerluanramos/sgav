<div class="p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg mt-3">
    <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Regras de Pontuação do Período</h3>
    @foreach ($regrasPontuacao as $index => $regra)
        <div class="flex items-center gap-2 mb-3">
            ...
            <div class="w-full md:w-2/12 mb-1 md:mb-0" style="margin-top: -22px">
                ...
                <label for="aplicar_todos_periodo{{ $index }}" class="flex px-3 items-center cursor-pointer">
                    <div class="relative">
                        <input type="checkbox"
                            id="aplicar_todos_periodo{{ $index }}"
    ...
    <input type="hidden" name="regras_pontuacao_periodo" value="{{ json_encode($regrasPontuacao) }}">
</div>
